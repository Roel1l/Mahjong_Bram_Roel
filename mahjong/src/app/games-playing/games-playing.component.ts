...
@Component({
  selector: 'app-games-playing',
  templateUrl: './games-playing.component.html',
  styleUrls: ['./games-playing.component.scss']
})
export class GamesPlayingComponent extends UserDependendComponent implements OnInit {
