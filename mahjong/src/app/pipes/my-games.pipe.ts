...
//TODO
//test of deze pipe werkt
//maak aparte pipe voor filteren op open games / etc (status pipe die als input de gewenste status krijgt)
//Check hoe je meerdere pipes kan fixen 
